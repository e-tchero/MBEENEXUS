-- Seed Abuja MVP pricing configuration
-- This ensures the pricing engine has data to work with

-- Insert Abuja service zone (Abuja FCT boundary approximation)
INSERT INTO service_zones (name, slug, boundary, is_active, operating_hours) VALUES (
  'Abuja FCT',
  'abuja-fct',
  ST_GeographyFromText('SRID=4326;POLYGON((7.3 8.8, 7.7 8.8, 7.7 9.2, 7.3 9.2, 7.3 8.8))'),
  true,
  '{"monday":{"open":"06:00","close":"22:00"},"tuesday":{"open":"06:00","close":"22:00"},"wednesday":{"open":"06:00","close":"22:00"},"thursday":{"open":"06:00","close":"22:00"},"friday":{"open":"06:00","close":"22:00"},"saturday":{"open":"06:00","close":"22:00"},"sunday":{"open":"08:00","close":"20:00"}}'::jsonb
) ON CONFLICT (slug) DO NOTHING;

-- Insert pricing rule for Abuja
...
SELECT 
  ...
  sz.id,
  500.00,    -- base_fee
  100.00,    -- per_kilometer
  0.00,      -- per_kg (weight handled via bands)
  700.00,    -- minimum_fare
